...
import 'package:story_creator/archiveSelectionPage.dart';
import 'package:story_creator/archives/characterSelectionPage.dart';
import 'package:story_creator/archives/magicSelectionPage.dart';
import 'package:story_creator/archives/noteSelectionPage.dart';
...
import 'package:story_creator/archives/worldSelectionPage.dart';
import 'package:story_creator/builders/magicBuilderPage.dart';
import 'package:story_creator/guidesPage.dart';
import 'package:story_creator/storySelectionPage.dart';

import 'archives/beliefSelectionPage.dart';
import 'builderSelectionPage.dart';
import 'archives/technologySelectionPage.dart';
...
class MenuPage extends StatefulWidget {
  final List<Widget> buttons = [
    RouteButton(text: 'Story', color: Colors.blue, icon: Icons.library_books, route: '/storySelection'),
    RouteButton(text: 'Archive', color: Colors.orange, icon: Icons.archive, route: '/archiveSelection'),
    RouteButton(text: 'World Builder', color: Colors.green, icon: Icons.public, route: '/builderSelection'),
    RouteButton(text: 'Guides', color: Colors.purple, icon: Icons.help, route: '/guides'),
    RouteButton(text: 'Character Profiler', color: Colors.red, icon: Icons.face, route: '/characterBuilder'),
    RouteButton(text: 'Notes', color: Colors.yellow, icon: Icons.edit, route: '/noteBuilder')
  ];
            ...
            builder: (context, orientation) =>
                Column(children: <Widget>[
                  Padding(padding: EdgeInsets.only(top: 50),
                      child: Center(child: Text('Story Creator', style: TextStyle(fontSize: 48)))),
