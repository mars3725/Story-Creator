          ...
          content: Padding(
              ...
              child: Wrap(runSpacing: 20, children: <Widget>[
                ...
                textField(
                    binding: 'experience',
                    label:
                    'What experience do you want your audience to be left with?')
              ]))),
      Step(
          title: Text('Setting'),
          content: Padding(
              ...
              child: Wrap(runSpacing: 20, children: <Widget>[
                textField(
                    binding: 'whenSetting',
                    label: 'WHEN: What year? What time period or era?'),
                textField(
                    binding: 'whereSetting',
                    label:
                    'WHERE: What universe? Planet? Country? State? Town?'),
                textField(
                    binding: 'whatSetting',
                    label: 'WHAT: What makes the place unique?'),
                textField(
                    binding: 'whySetting',
                    label: 'WHY: Why this world and not another?')
              ]))),
      Step(
          ...
          content: Padding(
              ...
              child: Wrap(runSpacing: 20, children: <Widget>[
                Text('Protagonist'),
                textField(
                    binding: 'protagonistWho',
                    label: 'Name, Sex, Age, Race, Profession'),
                textField(
                    binding: 'protagonistActualStrength',
                    label: 'What is their actual strength?'),
                textField(
                    binding: 'protagonistActualStrengthReason',
                    label: 'Why do they ACTUALLY have this strength?'),
                textField(
                    binding: 'protagonistInnerConflict',
                    label: 'What are they struggling with?'),
                textField(
                    binding: 'protagonistConflictReason',
                    label: 'Why are they struggling?'),
                textField(
                    binding: 'protagonistEstablishedNorm',
                    label: 'What are they doing now?'),
                textField(
                    binding: 'protagonistGoal',
                    label: 'What does the protagonist want?'),
                textField(
                    binding: 'protagonistDistinctiveness',
                    label: 'What makes them dynamic?'),
                Text('Deuteragonist'),
                textField(
                    binding: 'deuteragonistWho',
                    label: 'Name, Sex, Age, Race, Profession'),
                textField(
                    binding: 'deuteragonistActualStrength',
                    label: 'What is their actual strength?'),
                textField(
                    binding: 'deuteragonistActualStrengthReason',
                    label: 'Why do they ACTUALLY have this strength?'),
                textField(
                    binding: 'deuteragonistPercievedStrength',
                    label: 'What is their percieved strength?'),
                textField(
                    binding: 'deuteragonistPercievedStrengthReason',
                    label: 'Why do they THINK they have this strength?'),
                textField(
                    binding: 'deuteragonistInnerConflict',
                    label: 'What are they struggling with?'),
                textField(
                    binding: 'deuteragonistConflictReason',
                    label: 'Why are they struggling?'),
                textField(
                    binding: 'deuteragonistEstablishedNorm',
                    label: 'What are they doing now?'),
                textField(
                    binding: 'deuteragonistGoal',
                    label: 'What does the deuteragonist want?'),
                textField(
                    binding: 'deuteragonistSignifigance',
                    label:
                    'Why is this character important to the protagonist?'),
                textField(
                    binding: 'deuteragonistSimilarity',
                    label:
                    'How does the deuteragonist relate to the protagonist?'),
                Text('Tertiary'),
                textField(
                    binding: 'tertiaryWho',
                    label: 'Name, Sex, Age, Race, Profession'),
                textField(
                    binding: 'tertiaryActualStrength',
                    label: 'What is their actual strength?'),
                textField(
                    binding: 'tertiaryActualStrengthReason',
                    label: 'Why do they ACTUALLY have this strength?'),
                textField(
                    binding: 'tertiaryPercievedStrength',
                    label: 'What is their percieved strength?'),
                textField(
                    binding: 'tertiaryPercievedStrengthReason',
                    label: 'Why do they THINK they have this strength?'),
                textField(
                    binding: 'tertiaryInnerConflict',
                    label: 'What are they struggling with?'),
                textField(
                    binding: 'tertiaryConflictReason',
                    label: 'Why are they struggling?'),
                textField(
                    binding: 'tertiaryEstablishedNorm',
                    label: 'What are they doing now?'),
                textField(
                    binding: 'tertiaryGoal',
                    label: 'What does the tertiary character want?'),
                textField(
                    binding: 'tertiarySignifigance',
                    label:
                    'Why is this character important to the protagonist?'),
                textField(
                    binding: 'tertiarySimilarity',
                    label:
                    'How does the deuteragonist relate to the protagonist?'),
                Text('Antagonist'),
                textField(
                    binding: 'antagonistWho',
                    label: 'Name, Sex, Age, Race, Profession'),
                textField(
                    binding: 'antagonistActualStrength',
                    label: 'What is their actual strength?'),
                textField(
                    binding: 'antagonistActualStrengthReason',
                    label: 'Why do they ACTUALLY have this strength?'),
                textField(
                    binding: 'antagonistPercievedStrength',
                    label: 'What is their percieved strength?'),
                textField(
                    binding: 'antagonistPercievedStrengthReason',
                    label: 'Why do they THINK they have this strength?'),
                textField(
                    binding: 'antagonistInnerConflict',
                    label: 'What are they struggling with?'),
                textField(
                    binding: 'antagonistConflictReason',
                    label: 'Why are they struggling?'),
                textField(
                    binding: 'antagonistEstablishedNorm',
                    label: 'What are they doing now?'),
                textField(
                    binding: 'antagonistGoal',
                    label: 'What does the tertiary character want?'),
                textField(
                    binding: 'antagonistSignifigance',
                    label:
                    'Why is this character important to the protagonist?'),
                textField(
                    binding: 'antagonistSimilarity',
                    label:
                    'How does the antagonist relate to the protagonist?'),
                textField(
                    binding: 'antagonistDistinctiveness',
                    label: 'What makes them dynamic?')
              ]))),
      Step(
          title: Text('Plot'),
          content: Padding(
              ...
              child: Wrap(runSpacing: 20, children: <Widget>[
                ...
                Text(
                    'Objective: What is the immediate goal that they will either succeed or fail at by the end of the story?'),
                ...
                Text('Obstacle'),
                Text(
                    'Villian: The group, person, event, system, condition, or location that hinders them'),
      ...
      Step(
          ...
          content: Padding(
              ...
              child: Wrap(runSpacing: 20, children: <Widget>[
                ...
                Text(
                    "INCITING INCIDENT: Introduce the character's intention, obstacle, and stakes"),
                ...
                Text('Middle: Conflict'),
                Text(
                    'RISING ACTION: What events occur that directly affect the characters?'),
                ...
                Text(
                    "RISING REACTION: What are the consequences of these actions?"),
                ...
                Text('End: Conclusion'),
                Text(
                    'FALLING ACTION: What is the final action the characters take to achieve their intention?'),
                ...
                Text(
                    'CONSEQUENCE: What is the result of the falling action and why?'),
                ...
                Text(
                    "RESOLUTION: What has changed in the protagonist? What will they do now?"),
      ...
      Step(
          ...
          content: Padding(
              ...
              child: Wrap(runSpacing: 20, children: <Widget>[
                Text('Beginning'),
                textField(
                    binding: 'characters', label: 'This is a story about'),
                ...
                textField(
                    binding: 'risingReactionReason', label: 'Which Means'),
                Text('End'),
  ...
  saveData() async {
    if (widget.data['id'] == null)
      await database.insert(
          'stories', widget.data..['id'] = Random().nextInt(1000000),
          conflictAlgorithm: ConflictAlgorithm.replace);
    else
      await database.update('stories', widget.data,
